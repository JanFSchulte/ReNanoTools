...
# with command line options: step3 -s NANO --conditions 124X_dataRun3_Prompt_v4 --datatier NANOAODSIM -n 10 --eventcontent NANOAODSIM --geometry DB:Extended --era Run3 --customise=PhysicsTools/NanoAOD/V10/nano_cff.nanoAOD_customizeV10 --filein file:step2.root --fileout file:nano.root --data
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/data/Run2022C/EGamma/MINIAOD/PromptReco-v1/000/355/865/00000/41bc873d-2b31-4588-9fbd-bd193af8ecdc.root'),
